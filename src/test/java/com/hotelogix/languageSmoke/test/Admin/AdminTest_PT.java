...
public class AdminTest_PT {
	...
	public void TC_02_03() throws Exception{
		try{
		new AdminHomePage().fn_NavigateAnyModule(GenericMethods.GI().getWebElement("Hotelogix_admin_Homepage_RoomManager_Link"), GenericMethods.GI().getWebElement("Hotelogix_admin_Homepage_Amenities_Link"));
		}catch(Exception e){
			throw e;
		}
	    }
